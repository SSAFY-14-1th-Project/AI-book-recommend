# Generated by Django 5.2.6 on 2025-12-25 06:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "isbn",
                    models.CharField(
                        max_length=13, unique=True, verbose_name="ISBN-13"
                    ),
                ),
                ...
                (
                    "mall_type",
                    models.CharField(
                        blank=True, max_length=20, null=True, verbose_name="판매처"
                    ),
                ),
                ...
                (
                    "description",
                    models.TextField(blank=True, null=True, verbose_name="도서 소개"),
                ),
                (
                    "pub_date",
                    models.DateField(blank=True, null=True, verbose_name="출판일"),
                ),
                (
                    "adult",
                    models.BooleanField(default=False, verbose_name="성인 도서 여부"),
                ),
                (
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("user", "book"), name="unique_user_book_bookmark"
                    )
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="book",
            index=models.Index(
                fields=["-customer_review_rank"], name="idx_book_review_rank"
            ),
        ),
        migrations.AddIndex(
            model_name="book",
